...
class OperationalSpaceController(Controller):
    ...
    def __init__(self,
        ...
        # control dims that are zeroed out
    ...
    def set_goal(self, action, set_pos=None, set_ori=None):
        ...
        if (not input_set_ori_is_None) or sum(bools) > 0.:
    ...
    def control_limits(self):
        ...
        """
        # Cache control limits since they don't change after initialization
        if not hasattr(self, '_cached_control_limits'):
            ...
            self._cached_control_limits = (low, high)
        return self._cached_control_limits
