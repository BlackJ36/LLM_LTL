...
def process_variant(variant):
    ...
    # TensorBoard logging
    variant['use_tensorboard'] = args.tensorboard
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_envs', type=int, default=1,
                        help='Number of parallel exploration environments (default: 1, no vectorization)')
    parser.add_argument('--dummy_vec_env', action='store_true',
                        help='Use DummyVecEnv (sequential) instead of SubprocVecEnv for debugging')
